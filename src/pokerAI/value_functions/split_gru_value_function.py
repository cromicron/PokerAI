        ...
        for epoch in range(epochs):
            ...
            for batch in dataloader:
                ...
                if weights is not None:
                    batch_observations, batch_targets, batch_mask, batch_weights = batch
                else:
                ...
                masked_loss = raw_loss * batch_mask.float()*batch_weights  # Apply mask to ignore invalid timesteps
