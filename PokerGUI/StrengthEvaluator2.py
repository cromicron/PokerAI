...
flopModel = load_model('strengthFlop2.h5', custom_objects={"K": K})
turnModel = load_model('strengthTurn2.h5', custom_objects={"K": K})
riverModel = load_model('strengthRiver2.h5', custom_objects={"K": K})
