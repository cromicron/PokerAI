...
class Agent2():
    def __init__(self, lr, gamma, n_actions, epsilon, batch_size, input_dims,
                ...
                mem_size=1000000, fname='HUPoker.h5', handEval = True, layerSizes = (16,8)):
    ...
    def learn(self):
        ...
        for i in batch_index:
            q_target[i, 0] = states[i, 1] -stacksize+0.5 if states[i, 0] == 0 else states[i,2] -stacksize+1
    ...
    def learnMass(self):
        ...
        self.q_eval.fit(states, q_target, batch_size=16, epochs=1)
